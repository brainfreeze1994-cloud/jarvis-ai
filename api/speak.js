    ...
    if (imageBase64) {
      ...
      if (GROQ_API_KEY) {
        try {
          ...
          console.error('Groq vision error:', vText.slice(0, 200));
        } catch (visionErr) {
